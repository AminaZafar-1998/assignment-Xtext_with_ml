 ...
 * </p>
 * <ul>
 *   <li>{@link assignment_2_ssda.xtext_ml.ass2.myDsl.Medicines#getMedicine_name <em>Medicine name</em>}</li>
 *   <li>{@link assignment_2_ssda.xtext_ml.ass2.myDsl.Medicines#getMedicine_dossage <em>Medicine dossage</em>}</li>
 * </ul>
 *
 * @see assignment_2_ssda.xtext_ml.ass2.myDsl.MyDslPackage#getMedicines()
 * @model
 * @generated
 */
public interface Medicines extends EObject
{
   ...
   * @see assignment_2_ssda.xtext_ml.ass2.myDsl.MyDslPackage#getMedicines_Medicine_name()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link assignment_2_ssda.xtext_ml.ass2.myDsl.Medicines#getMedicine_name <em>Medicine name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see assignment_2_ssda.xtext_ml.ass2.myDsl.MyDslPackage#getMedicines_Medicine_dossage()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link assignment_2_ssda.xtext_ml.ass2.myDsl.Medicines#getMedicine_dossage <em>Medicine dossage</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
